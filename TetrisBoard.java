...
public class TetrisBoard implements KeyListener
{
    ...
    public void run()
    {
        while (true) // Game continues indefinitely for now
        {
            ...
            do  {
                ...
                Utilities.sleep(500);
            } while (!this.CONTROLLER.tetronimoLanded(this.tetronimo, this.occupied));

            // Lock the piece to the board
            this.CONTROLLER.lockTetronimo(this.tetronimo, this.occupied);
            this.tetronimo = null;
        }
    }
    ...
    public void keyPressed( KeyEvent e )
    {
        ...
        {
            case 38:
                if(CONTROLLER.readyToRotate(tetronimo, occupied))
                {
                    tetronimo.rotate();
                }
                break;
            case 37:
                if( this.tetronimo.getXLocation() - Tetronimo.SIZE >= 40  &&
                        this.CONTROLLER.canMoveLeft(this.tetronimo, this.occupied) )
                {
            ...
            case 39:
                if( (this.tetronimo.getXLocation() + this.tetronimo.getWidth()) <
                        ...
                        this.CONTROLLER.canMoveRight(this.tetronimo, this.occupied) )
                {
